...
function createCard(date, day, games) {
    ...
    delay = delay + 0.4;
    return `
        <ul class="card" style="animation-delay: ${delay}s" >
            <h2 class="card-date">${date} <span class="card-day">${day}</span></h2>
            ${games}
        </ul>
    `
}
...
//      ``      ==      Pode fazer quebra de linha para adcionar a string
//      ${function()}       ==      Interpolação    /   Template String